...
function Game(){
    ...
    this.init = function(){
        ...
        this.player2.push(array_list[3][3].addClass('white-disc').off("click"));
        this.player1.push(array_list[3][4].addClass('black-disc').off("click"));
        this.player1.push(array_list[4][3].addClass('black-disc').off("click"));
        this.player2.push(array_list[4][4].addClass('white-disc').off("click"));
